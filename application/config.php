...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => ':r,;0%-=*qaw9Qv<RkD|48t/Lh1[5uyWAex6~3J!', //默认数据加密KEY
	'data_cache_key'=> ':r,;0%-=*qaw9Qv<RkD|48t/Lh1[5uyWAex6~3J!',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>':r,;0%-=*qaw9Qv<RkD|48t/Lh1[5uyWAex6~3J!', //加密KEY
