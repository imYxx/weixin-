<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"../application/admin/view/repair/index.html";i:1506680631;s:82:"F:\phpStudy\WWW\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="data-table table-striped">
    <table class="">
        ...
        <tr>
            ...
            <td><?php echo $vo['stutas']; ?></td>
            <td><?php if($vo['status'] == '1'): else: ?>
                <a  href="<?php echo url('edit?id='.$vo['id']); ?>">编辑</a>
                <?php endif; ?>
                <a href="<?php echo url('del?id='.$vo['id']); ?>" title="删除" class="confirm ajax-get">删除</a>
