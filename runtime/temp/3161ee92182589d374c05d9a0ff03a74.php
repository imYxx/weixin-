<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:41:"../application/admin/view/repair/add.html";i:1506675408;s:82:"F:\phpStudy\WWW\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
    ...
    <div class="form-item">
        <label class="item-label">地址<span class="check-tips">（几栋几单元几号）</span></label>
        <div class="controls">
    ...
    <div class="form-item">
        <label class="item-label">内容<span class="check-tips">（请详细填写问题内容）</span></label>
        <div class="controls">
